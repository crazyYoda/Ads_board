...
SECRET_KEY = 'django-insecure-$4c%qod)^aya4x_okghuja0n_17()ze1+#mm3%0jt5sfbatosf'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'ads_board/static'),
]
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'test_for_skills'
EMAIL_HOST_PASSWORD = 'AFSH1oca1oy$'
EMAIL_USE_SSL = True
